...
const allMyLanguageData = {
    ru: {
      ...
      subscriptionSection: {
        ...
        mainSubtitle: 'Выберите подходящий тариф и получите полный доступ к сервисам 4Pets.',
        ...
        subscriptionCards: [
          {
            ...
            text: 'Идеально для знакомства с нашими возможностями. ',
            priceInSoms: 0,
          ...
          },
          {
            ...
            text: 'Больше функций для активных пользователей.',
            priceInSoms: 500,
          ...
          },
          {
            ...
            text: 'Полный пакет опций для профессионалов и бизнеса. ',
            priceInSoms: 1000,
    ...
    kg: {
      ...
      subscriptionSection: {
        ...
        mainSubtitle: 'Платформабыздын бардык мүмкүнчүлүктөрүн ачуу үчүн өз тарифиңизди тандаңыз.',
        everyMonth: 'айлык',
        subscriptionCards: [
          {
            id: 1,
            ...
            text: 'Таанышуу үчүн эң ылайыктуу. ',
            priceInSoms: 0,
            icon: FreeSubscriptionIcon,
          ...
          },
          {
            ...
            text: 'Активдүү колдонуучулар үчүн кеңейтилген мүмкүнчүлүктөр.',
            priceInSoms: 500,
            icon: BasicSubscriptionIcon,
            whatIsIncluded: 'Эмне камтылган',
            list: [
          ...
          },
          {
            ...
            type: 'Ишкердик',
            subscriptionType: 'Про',
            text: 'Бизнес жана командалар үчүн толук мүмкүнчүлүктөр. ',
            priceInSoms: 1000,
            icon: ProSubscriptionIcon,
            whatIsIncluded: 'Эмне камтылган',
            list: [
    ...
    en: {
      ...
      subscriptionSection: {
        ...
        mainSubtitle: 'Choose a plan that fits you and unlock all features of 4Pets.',
        everyMonth: 'monthly',
        subscriptionCards: [
          {
            id: 1,
            ...
            text: 'Perfect for getting started with 4Pets. ',
            priceInSoms: 0,
            icon: FreeSubscriptionIcon,
          ...
          },
          {
            ...
            text: 'Full power for professionals and teams. ',
            priceInSoms: 1000,
            icon: ProSubscriptionIcon,
            whatIsIncluded: "What's included",
            list: [
